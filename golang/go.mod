...
require (
	github.com/ideamans/libnextimage/golang/avifenc v0.0.0-00010101000000-000000000000
	github.com/ideamans/libnextimage/golang/cwebp v0.0.0-00010101000000-000000000000
	github.com/ideamans/libnextimage/golang/dwebp v0.0.0-00010101000000-000000000000
)
